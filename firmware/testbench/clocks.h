...
#define CLOCKS_TICKS_TO_US(x)                   \
    ( ( ((uint64_t)(x)) * ((uint64_t)1000000ULL) ) / (uint64_t)CLOCKS_SYSTEM_FREQUENCY )
#define CLOCKS_TICKS_TO_NS(x)                   \
    ( ( ((uint64_t)(x)) * ((uint64_t)1000000000ULL) ) / (uint64_t)CLOCKS_SYSTEM_FREQUENCY )
#define CLOCKS_US_TO_TICKS(x)                   \
    ( ( ((uint64_t)(x)) * ((uint64_t)CLOCKS_SYSTEM_FREQUENCY) ) / (uint64_t)1000000ULL )
#define CLOCKS_TICKS_TO_MS(x)                   \
    ( ( ((uint64_t)(x)) * ((uint64_t)1000ULL) ) / (uint64_t)CLOCKS_SYSTEM_FREQUENCY )
#define CLOCKS_MS_TO_TICKS(x)                   \
    ( ( ((uint64_t)(x)) * ((uint64_t)CLOCKS_SYSTEM_FREQUENCY) ) / (uint64_t)1000ULL )
